...
public class SwipeManager : MonoBehaviour
{
    ...
    [Tooltip("Set this to true if you want to include swipe gestures by mouse into your final build game.")]
    [SerializeField] private bool includeSwipeByMouseIntoFinalBuild;
    ...
    //if swipe by mouse is to be included in the build
    private void CheckAndIncludeSwipeForMouse()
    {
        if (includeSwipeByMouseIntoFinalBuild)
        {
        ...
        else
        {
            ...
            //* Only gets triggered in the editor */
            DetectAndTriggerSwipeForMouseInput();
